...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-725a2fde2d7ab657874c" style="width:30%;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-725a2fde2d7ab657874c">{"x":{"diagram":" digraph plot { \n graph [ overlap = true, fontsize = 10 ] \n node [ shape = box ] \n node [shape = box] \n Motivasyon; Kaygi; Performans \n node [shape = oval] \n  \n \n edge [ color = black ] \n Motivasyon->Performans [label = \"0.88\"] Kaygi->Performans [label = \"-0.37\"]  \n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-396ffc355e5b50eb40ab" style="width:30%;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-396ffc355e5b50eb40ab">{"x":{"diagram":" digraph plot { \n graph [ overlap = true, fontsize = 10 ] \n node [ shape = box ] \n node [shape = box] \n Motivasyon; Kaygi; Performans \n node [shape = oval] \n  \n \n edge [ color = black ] \n Motivasyon->Performans [label = \"0.69\"] Kaygi->Performans [label = \"-0.61\"]  \n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
- Hem **çokluklu bağlantı problemi**, hem de **ana etkilerden birinin diğer ana etkinin uc değerinde değerlendirilmesi** problemi istenmeyen 
durumlardir.
...
bağımsız değişkenin etkileşimini incelemek uzere etkileşim terimi de 
...
<img src="04-CR_files/figure-html/unnamed-chunk-71-1.png" width="100%" style="display: block; margin: auto;" />
...
- Veriler altı bölümden gelmektedir. Gizlilik için bunlara A-F olarak kodalnmıştır.
...
<img src="04-CR_files/figure-html/unnamed-chunk-77-1.png" width="100%" style="display: block; margin: auto;" />
