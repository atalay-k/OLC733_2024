...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-6c741528023a910dd0b4" style="width:30%;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-6c741528023a910dd0b4">{"x":{"diagram":" digraph plot { \n graph [ overlap = true, fontsize = 10 ] \n node [ shape = box ] \n node [shape = box] \n Motivasyon; Kaygi; Performans \n node [shape = oval] \n  \n \n edge [ color = black ] \n Motivasyon->Performans [label = \"0.88\"] Kaygi->Performans [label = \"-0.37\"]  \n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-464a6c961f6e439e07e0" style="width:30%;height:480px;"></div>
<script type="application/json" data-for="htmlwidget-464a6c961f6e439e07e0">{"x":{"diagram":" digraph plot { \n graph [ overlap = true, fontsize = 10 ] \n node [ shape = box ] \n node [shape = box] \n Motivasyon; Kaygi; Performans \n node [shape = oval] \n  \n \n edge [ color = black ] \n Motivasyon->Performans [label = \"0.69\"] Kaygi->Performans [label = \"-0.61\"]  \n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
artmasının bekleneceğini, daha az sosyal desteğe sahip bireyler için ise,
semptomların stres arttıkça daha hızlı artmasının bekleneceğini belirttiler.
...
dışında dört değişken ve 56 üniversite birinci sınıf öğrencisini 
içermektedir. Veri setine aşağıdaki 🔗[web adresinden ulaşılabilir:](https://www.uvm.edu/~statdhtx/methods8/DataFiles/DataSets.html)
...
<img src="04-CR_files/figure-html/unnamed-chunk-57-1.png" width="40%" style="display: block; margin: auto;" />
...
- diğer bir ifadeyle, Sorun üzerindeki test hiç sosyal desteği olmayan bir katılımcı için Sorunların belirtilerle ilişkili olup olmadığı testi olacaktır.  

- Benzer şekilde, destek üzerindeki test hiç Sorunları olmayan katılımcılar için değerlendirilecektir. 

- Hem **çoklu bağlantı problemi**, hem de **ana etkilerden birinin diğer ana etkinin uç değerinde değerlendirilmesi** problemi istenmeyen 
durumlardır.
...
<img src="04-CR_files/figure-html/unnamed-chunk-60-1.png" width="70%" style="display: block; margin: auto;" />


- Belirtilerin bağımlı degişken, merkezlenen sorunların ve merkezlenen
desteğin bağımsız değişken olarak modellendigi regresyonda, iki
...
<img src="04-CR_files/figure-html/unnamed-chunk-75-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="04-CR_files/figure-html/unnamed-chunk-81-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="04-CR_files/figure-html/unnamed-chunk-84-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="04-CR_files/figure-html/unnamed-chunk-90-1.png" width="100%" style="display: block; margin: auto;" />
